#!/bin/bash
#-----------------------------------------------------------------------
# Sets up a streamripper.service on Ubuntu
#
# Usage:
...
#
#
# AD 2020-0809-1600 Updated to make it more generic.
...
rc=$?
if [ 0 != ${rc} ] ; then
    echo "WARNING ${rc} Could not show service status. May be caused by network not running or MP3 programming not being streamed."
fi

...
Usage: Intended to be invoked every two hours or so, to upload
the latest mp3 file from the archiver.
...
#exitcode,md5sum = get_remote_file_md5sum(USERNAME, HOSTNAME, '/home/ding/bmir2018/ice/0822/bmir.2018-0822-0000.2018-0822-0200.mp3')
#sop(5,m,'exitcode=%i' % (exitcode))
#sop(5,m,'md5sum=%s' % (md5sum))

#print delimeter
# UNIT TEST get-remote-md5sum - file not found
#exitcode,md5sum = get_remote_file_md5sum(USERNAME, HOSTNAME, '/home/ding/bmir2018/ice/0822/testme.mp3')
#sop(5,m,'exitcode=%i' % (exitcode))
#sop(5,m,'md5sum=%s' % (md5sum))

#print delimeter
# UNIT TEST mkdir happy path
#dirstr = '/home/ding/bmir2018/ice/eraseme'
...
#exitcode,md5sum = get_local_file_md5sum('/home/ding/.bashrc')
#sop(5,m,'exitcode=%i' % (exitcode))
#sop(5,m,'md5sum=%s' % (md5sum))

#print delimeter
# UNIT TEST get-local-md5sum - file not found
#exitcode,md5sum = get_local_file_md5sum('/home/ding/nonexistent.mp3')
#sop(5,m,'exitcode=%i' % (exitcode))
#sop(5,m,'md5sum=%s' % (md5sum))
